...
const file_proto_api_v1_log_proto_rawDesc = "" +
	"\n" +
	"\x16proto/api/v1/log.proto\x12\x06log.v1\"6\n" +
	"\x06Record\x12\x14\n" +
	...
	"\rProduceStream\x12\x16.log.v1.ProduceRequest\x1a\x17.log.v1.ProduceResponse\"\x00(\x010\x01B.Z,github.com/Bangseungjae/proglog/proto/api/v1b\x06proto3"

var (
	file_proto_api_v1_log_proto_rawDescOnce sync.Once
	file_proto_api_v1_log_proto_rawDescData []byte
)

func file_proto_api_v1_log_proto_rawDescGZIP() []byte {
	file_proto_api_v1_log_proto_rawDescOnce.Do(func() {
		file_proto_api_v1_log_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_api_v1_log_proto_rawDesc), len(file_proto_api_v1_log_proto_rawDesc)))
	})
	return file_proto_api_v1_log_proto_rawDescData
}

var file_proto_api_v1_log_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_proto_api_v1_log_proto_goTypes = []any{
...
func file_proto_api_v1_log_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_api_v1_log_proto_rawDesc), len(file_proto_api_v1_log_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
